...
const queryInterTransferList = async (req, res) => {
    try {
        ...
        const response = await axios.get('https://api.bybit.com/v5/asset/transfer/query-inter-transfer-list', {
            headers: {
...
module.exports = { queryInterTransferList };
