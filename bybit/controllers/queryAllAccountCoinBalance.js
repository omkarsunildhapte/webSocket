...
const queryAllAccountCoinsBalance = async (req, res) => {
    try {
        ...
        const response = await axios.get('https://api.bybit.com/v5/asset/transfer/query-account-coins-balance', {
            headers: {
...
module.exports = { queryAllAccountCoinsBalance };
