...
const getAssetTransferInfo = async (req, res) => {
    try {
        ...
        const response = await axios.get('https://api.bybit.com/v5/asset/transfer/query-asset-info', {
            headers: {
...
module.exports = { getAssetTransferInfo };
