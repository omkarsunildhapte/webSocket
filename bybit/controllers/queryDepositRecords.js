...
const queryDepositRecords = async (req, res) => {
    try {
        ...
        const response = await axios.get('https://api.bybit.com/v5/asset/deposit/query-record', {
            headers: {
...
module.exports = { queryDepositRecords };
