...
const queryAccountCoinBalance = async (req, res) => {
    try {
        ...
        const response = await axios.get('https://api.bybit.com/v5/asset/transfer/query-account-coin-balance', {
            headers: {
...
module.exports = { queryAccountCoinBalance };
