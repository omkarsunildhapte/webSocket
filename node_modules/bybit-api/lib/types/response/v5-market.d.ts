...
declare type InstrumentInfoV5Mapping = {
...
export declare type InstrumentInfoResponseV5<C extends CategoryV5> = CategoryCursorListV5<InstrumentInfoV5Mapping[C], C>;
